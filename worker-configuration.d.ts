/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e3cf7eadfab46c741ac70f479adbde1f)
...
interface __BaseEnv_Env {
	...
	ADMIN_EMAILS: string;
	APP_URL: string;
	COLLAB_DESCRIPTIONS: string;
	EMAIL_FROM: string;
	SLACK_CLIENT_ID: string;
	SLACK_CLIENT_SECRET: string;
	SLACK_DRY_RUN: string;
	...
	NOTIFICATION_ROOM: DurableObjectNamespace<import("./src/worker/index").NotificationRoom>;
	DESCRIPTION_ROOM: DurableObjectNamespace<import("./src/worker/index").DescriptionRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "ChatAgent" | "TimerRoom" | "NotificationRoom" | "DescriptionRoom";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "GOOGLE_CALENDAR_CLIENT_ID" | "GOOGLE_CALENDAR_CLIENT_SECRET" | "MICROSOFT_CALENDAR_CLIENT_ID" | "MICROSOFT_CALENDAR_CLIENT_SECRET" | "MICROSOFT_CALENDAR_TENANT" | "ENABLE_PASSWORD_AUTH" | "RESEND_API_KEY" | "ADMIN_EMAILS" | "APP_URL" | "COLLAB_DESCRIPTIONS" | "EMAIL_FROM" | "SLACK_CLIENT_ID" | "SLACK_CLIENT_SECRET" | "SLACK_DRY_RUN">> {}
}
