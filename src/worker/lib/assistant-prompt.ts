...
- finding a task the user named: ONE list_tasks call with search = a distinctive word of its name (no list_projects first, no assignee filter unless they said "my"); if two match, tell them apart by project, notes or comments, or ask
