...
- finding a task the user named: ONE list_tasks call with search = the words they used for its name (typos are fine; it matches any word) (no list_projects first, no assignee filter unless they said "my"); if two match, tell them apart by project, notes or comments, or ask
